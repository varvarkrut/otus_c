...
iso8859_5ToUnicode iso8859_5Table[] = {
        ...
        {0xF1, 0x2116}, {0xF2, 0x0451}, {0xF3, 0x0451}, {0xF4, 0x0452}, {0xF5, 0x0453}, {0xF6, 0x0454}, {0xF7, 0x0455}, {0xF8, 0x0456}, {0xF9, 0x0457},
        {0xFA, 0x0458}, {0xFB, 0x0459}, {0xFC, 0x045A}, {0xFD, 0x045B}, {0xFE, 0x045C}, {0xFF, 0x00A0}
};

uint16_t iso8859_5_to_unicode(uint8_t iso8859_5) {
    int i, tableSize = sizeof(iso8859_5Table) / sizeof(iso8859_5ToUnicode);
    for (i = 0; i < tableSize; i++) {
        if (iso8859_5Table[i].iso8859_5 == iso8859_5) {
            return iso8859_5Table[i].unicode;
        }
    }
